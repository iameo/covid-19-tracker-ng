...
app.layout = html.Div([
                ...
                dbc.Row([
                    dbc.Col([
                        html.P("Most servers that provided data for this application has died off, and as such no streaming and plotting of data here any longer. Apologies for the inconvenience.")
                    ]),
                ...
                dbc.Container([
                    dbc.Row([
                        dbc.Col(
                            [  
                            dcc.Markdown("Made with love by [EMMANUEL](https://www.twitter.com/__oemmanuel__)", style={
                                                                                                            'cursor': 'grab', 
                                                                                                            'color': 'cyan',
                                                                                                            'font-weight': 'bold'
                                                                                                            }),
